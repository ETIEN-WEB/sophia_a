...
if(isset($_POST['formcandidat']))
{
    ...
    $niveau2 = checkInput($_POST['niveau2']);
    $emploi = checkInput($_POST['emploi']);
    $emploi2 = checkInput($_POST['emploi2']);
	  ...
	  {*/
          /*if(!empty($name)) {
            ...
            if(!empty($quartier)) {*/
                ...
                $db = Database::connect();
                $statement = $db->prepare("INSERT INTO candidare (name, telephone, quartier, niveau, niveau2, emploi, emploi2, message) values(?, ?, ?, ?, ?, ?, ?, ?)");

                $statement->execute(array($name, $telephone, $quartier, $niveau, $niveau2, $emploi,  $emploi2, $message));

                $statement1 = $db->query('SELECT * FROM candidare ORDER BY id DESC LIMIT 0, 1');
    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(images/hero_bg_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">Postez votre candidature</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
                ...
                <form action="candidat.php" method="post" class="p-5 bg-white">
                  ...
                  <div class="row form-group">
                    <div class="col-md-12 mb-3 mb-md-0">
                      <label class="font-weight-bold" for="personnel">Niveau d'étude</label>
                  ...
                  <div class="row form-group">
                    <div class="col-md-12 mb-3 mb-md-0">
                      <label class="font-weight-bold" for="entreprise">Autre niveau d'étude, précisez</label>
                      <input type="text" name="niveau2" id="entreprise" class="form-control" placeholder="préciser">
                    </div>
                  </div>

                  <div class="row form-group">
                    <div class="col-md-12 mb-3 mb-md-0">
                      <label class="font-weight-bold" for="personnel">Emploi Recherché</label>
                      <select name="emploi" class="form-control"  >
                          <option value="" selected="">Faites votre sélection</option>
                  ...
                  <div class="row form-group">
                    <div class="col-md-12 mb-3 mb-md-0">
                      <label class="font-weight-bold" for="personnel2"> autres choix, précisez </label>
                      <input type="text" name="emploi2" id="personnel2" class="form-control" placeholder="Personnel">
                    </div>
                  </div>
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      <input type="submit" value="Enregistrer" name="formcandidat" class="btn btn-primary text-white px-4 py-2">
                    </div>
                  </div>
...
if(result){
  swal({
title: "Félicitation!",
text: "Votre inscription a été effectué avec succès",
icon: "success",
button: "Fermer",
});
