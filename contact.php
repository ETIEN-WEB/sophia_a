      ...
      <div class="container">
        <div class="row">
          ...
          <form action="contact.php" method="post" class="p-5 bg-white">
            ...
            <div class="row form-group">
              <div class="col-md-12">
                <label class="font-weight-bold" for="message">votre message</label> 
            ...
            <div class="row form-group">
              <div class="col-md-12">
                <input type="submit" value="Enregistrer" name="formcontact" class="btn btn-primary text-white px-4 py-2">
              </div>
            </div>
